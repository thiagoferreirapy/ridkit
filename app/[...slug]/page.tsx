...
export async function generateMetadata({params}:{params:Promise<{slug:string[]}>}):Promise<Metadata>{
  ...
  const titles:Record<string,string>={capacetes:"Produtos",ofertas:"Ofertas",lancamentos:"Lançamentos",categorias:"Categorias",marcas:"Marcas",comparar:"Comparar produtos",conta:"Minha conta",checkout:"Checkout"};const title=titles[slug[0]];return title?{title,alternates:{canonical:path},robots:["conta","checkout","admin"].includes(slug[0])?{index:false,follow:false}:undefined}:{};
}
