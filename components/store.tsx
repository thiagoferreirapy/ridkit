      ...
      <header className="sticky top-0 z-40 border-b border-line bg-white/95 backdrop-blur">
        ...
        <div className="container-page flex h-16 items-center gap-3 md:h-20 md:gap-6">
          ...
          <nav className="hidden items-center gap-5 text-[13px] font-medium md:flex">
            <Link href="/capacetes">Categorias</Link><Link href="/conta/favoritos">Favoritos</Link><Link href="/conta">Conta</Link>
          </nav>
...
export function ProductVisual({tone="from-zinc-950 to-zinc-700", className="", image}:{tone?:string;className?:string;image?:string}) {
  return <div className={`relative grid min-h-24 place-items-center overflow-hidden rounded-[14px] bg-[#f1f3f5] ${className}`}>
    {image ? <img src={image} alt="Equipamento para motociclista" className="absolute inset-0 size-full object-cover transition duration-500 group-hover:scale-105"/> : <div className={`relative h-[55%] w-[58%] rounded-[48%_48%_38%_38%] bg-gradient-to-br ${tone} shadow-lg after:absolute after:right-[8%] after:top-[28%] after:h-[23%] after:w-[58%] after:rounded-full after:bg-slate-300/80 after:content-['']`} />}
  </div>;
}
