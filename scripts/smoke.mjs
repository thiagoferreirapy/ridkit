...
const checks=[["health","/api/health"],["catalog","/api/catalog"],["products","/api/products?limit=1"],["home","/"],["catalog page","/capacetes"],["checkout","/checkout/pagamento"],["compare","/comparar"],["robots","/robots.txt"],["sitemap","/sitemap.xml"]];
let failed=0;
