...
export const productSchema = z.object({
  ...
  images: z.array(z.object({ url: z.string().url(), alt: z.string().min(2), photographer: z.string().optional(), photographer_url: z.string().url().optional() })).default([]),
...
export const orderSchema = z.object({
  customer_id: z.coerce.number().int().positive(), coupon_code: z.string().trim().optional(),
